...
type RecipientKey = (Option<sequoia_openpgp::types::Features>, sequoia_openpgp::packet::Key<sequoia_openpgp::packet::key::PublicParts, sequoia_openpgp::packet::key::UnspecifiedRole>);
